...
function Sales() {
    ...
    useEffect(() => {
        async function getMonths() {
            await axios.get(`${process.env.REACT_APP_API}/get/sales`)
                .then((response) => {
    ...
    const handleAddMonthClick = async (event) => {
        ...
        if (newMonth && newYear) {
            await axios.post(`${process.env.REACT_APP_API}/post/sales/addMonth`, { month: newMonth, year: newYear })
                .then((response) => {
    ...
    const isChildRouteActive = location.pathname !== "/sales";
                    ...
                    <div className={styles.months}>
                        ...
                        {months.map((aMonth) => (
                            <Link
                                ...
                                to={`/sales/${aMonth.month.toLowerCase()}-${aMonth.year}`}
